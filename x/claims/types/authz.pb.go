...
// source: fury/claims/v1beta1/authz.proto
...
func init() {
	proto.RegisterType((*SubmitClaimAuthorization)(nil), "fury.claims.v1beta1.SubmitClaimAuthorization")
	proto.RegisterType((*SubmitClaimConstraints)(nil), "fury.claims.v1beta1.SubmitClaimConstraints")
	proto.RegisterType((*EvaluateClaimAuthorization)(nil), "fury.claims.v1beta1.EvaluateClaimAuthorization")
	proto.RegisterType((*EvaluateClaimConstraints)(nil), "fury.claims.v1beta1.EvaluateClaimConstraints")
	proto.RegisterType((*WithdrawPaymentAuthorization)(nil), "fury.claims.v1beta1.WithdrawPaymentAuthorization")
	proto.RegisterType((*WithdrawPaymentConstraints)(nil), "fury.claims.v1beta1.WithdrawPaymentConstraints")
}

func init() { proto.RegisterFile("fury/claims/v1beta1/authz.proto", fileDescriptor_f4b7f6c531e101a6) }
