...
// source: fury/claims/v1beta1/claims.proto
...
type Params struct {
	...
	FuryAccount           string                                 `protobuf:"bytes,2,opt,name=fury_account,json=furyAccount,proto3" json:"fury_account,omitempty"`
...
func (m *Params) GetFuryAccount() string {
	if m != nil {
		return m.FuryAccount
	}
	return ""
}
...
type Collection struct {
	...
	State CollectionState `protobuf:"varint,13,opt,name=state,proto3,enum=fury.claims.v1beta1.CollectionState" json:"state,omitempty"`
...
type ClaimPayments struct {
	Submission PaymentStatus `protobuf:"varint,1,opt,name=submission,proto3,enum=fury.claims.v1beta1.PaymentStatus" json:"submission,omitempty"`
	Evaluation PaymentStatus `protobuf:"varint,2,opt,name=evaluation,proto3,enum=fury.claims.v1beta1.PaymentStatus" json:"evaluation,omitempty"`
	Approval   PaymentStatus `protobuf:"varint,3,opt,name=approval,proto3,enum=fury.claims.v1beta1.PaymentStatus" json:"approval,omitempty"`
	Rejection  PaymentStatus `protobuf:"varint,4,opt,name=rejection,proto3,enum=fury.claims.v1beta1.PaymentStatus" json:"rejection,omitempty"`
}
...
type Evaluation struct {
	...
	// 3=rejected, ...)
	Status EvaluationStatus `protobuf:"varint,6,opt,name=status,proto3,enum=fury.claims.v1beta1.EvaluationStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("fury.claims.v1beta1.CollectionState", CollectionState_name, CollectionState_value)
	proto.RegisterEnum("fury.claims.v1beta1.EvaluationStatus", EvaluationStatus_name, EvaluationStatus_value)
	proto.RegisterEnum("fury.claims.v1beta1.PaymentType", PaymentType_name, PaymentType_value)
	proto.RegisterEnum("fury.claims.v1beta1.PaymentStatus", PaymentStatus_name, PaymentStatus_value)
	proto.RegisterType((*Params)(nil), "fury.claims.v1beta1.Params")
	proto.RegisterType((*Collection)(nil), "fury.claims.v1beta1.Collection")
	proto.RegisterType((*Payments)(nil), "fury.claims.v1beta1.Payments")
	proto.RegisterType((*Payment)(nil), "fury.claims.v1beta1.Payment")
	proto.RegisterType((*Contract1155Payment)(nil), "fury.claims.v1beta1.Contract1155Payment")
	proto.RegisterType((*Claim)(nil), "fury.claims.v1beta1.Claim")
	proto.RegisterType((*ClaimPayments)(nil), "fury.claims.v1beta1.ClaimPayments")
	proto.RegisterType((*Evaluation)(nil), "fury.claims.v1beta1.Evaluation")
	proto.RegisterType((*Dispute)(nil), "fury.claims.v1beta1.Dispute")
	proto.RegisterType((*DisputeData)(nil), "fury.claims.v1beta1.DisputeData")
}

func init() { proto.RegisterFile("fury/claims/v1beta1/claims.proto", fileDescriptor_619c1a0876cd0592) }
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x1a
	if len(m.FuryAccount) > 0 {
		i -= len(m.FuryAccount)
		copy(dAtA[i:], m.FuryAccount)
		i = encodeVarintClaims(dAtA, i, uint64(len(m.FuryAccount)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FuryAccount", wireType)
			}
			...
			m.FuryAccount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
