...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "fury.token.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "fury.token.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryTokenListRequest)(nil), "fury.token.v1beta1.QueryTokenListRequest")
	proto.RegisterType((*QueryTokenListResponse)(nil), "fury.token.v1beta1.QueryTokenListResponse")
	proto.RegisterType((*QueryTokenDocRequest)(nil), "fury.token.v1beta1.QueryTokenDocRequest")
	proto.RegisterType((*QueryTokenDocResponse)(nil), "fury.token.v1beta1.QueryTokenDocResponse")
	proto.RegisterType((*QueryTokenMetadataRequest)(nil), "fury.token.v1beta1.QueryTokenMetadataRequest")
	proto.RegisterType((*QueryTokenMetadataResponse)(nil), "fury.token.v1beta1.QueryTokenMetadataResponse")
	proto.RegisterType((*TokenMetadataProperties)(nil), "fury.token.v1beta1.TokenMetadataProperties")
}

func init() { proto.RegisterFile("fury/token/v1beta1/query.proto", fileDescriptor_ce478daca359f034) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenList(ctx context.Context, in *QueryTokenListRequest, opts ...grpc.CallOption) (*QueryTokenListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Query/TokenList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenDoc(ctx context.Context, in *QueryTokenDocRequest, opts ...grpc.CallOption) (*QueryTokenDocResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Query/TokenDoc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenMetadata(ctx context.Context, in *QueryTokenMetadataRequest, opts ...grpc.CallOption) (*QueryTokenMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Query/TokenMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Query/Params",
	}
...
func _Query_TokenList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Query/TokenList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TokenDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Query/TokenDoc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TokenMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Query/TokenMetadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.token.v1beta1.Query",
	...
	Metadata: "fury/token/v1beta1/query.proto",
}
