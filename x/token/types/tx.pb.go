...
// source: fury/token/v1beta1/tx.proto
...
import (
	...
	_ "github.com/furyfoundation/fury-blockchain/x/iid/types"
...
type MsgCreateToken struct {
	...
	Class github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=class,proto3,casttype=github.com/furyfoundation/fury-blockchain/x/iid/types.DIDFragment" json:"class,omitempty"`
...
func (m *MsgCreateToken) GetClass() github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.Class
	}
	return ""
...
func init() {
	proto.RegisterType((*MsgCreateToken)(nil), "fury.token.v1beta1.MsgCreateToken")
	proto.RegisterType((*MsgCreateTokenResponse)(nil), "fury.token.v1beta1.MsgCreateTokenResponse")
	proto.RegisterType((*MsgMintToken)(nil), "fury.token.v1beta1.MsgMintToken")
	proto.RegisterType((*MintBatch)(nil), "fury.token.v1beta1.MintBatch")
	proto.RegisterType((*MsgMintTokenResponse)(nil), "fury.token.v1beta1.MsgMintTokenResponse")
	proto.RegisterType((*MsgTransferToken)(nil), "fury.token.v1beta1.MsgTransferToken")
	proto.RegisterType((*MsgTransferTokenResponse)(nil), "fury.token.v1beta1.MsgTransferTokenResponse")
	proto.RegisterType((*TokenBatch)(nil), "fury.token.v1beta1.TokenBatch")
	proto.RegisterType((*MsgRetireToken)(nil), "fury.token.v1beta1.MsgRetireToken")
	proto.RegisterType((*MsgRetireTokenResponse)(nil), "fury.token.v1beta1.MsgRetireTokenResponse")
	proto.RegisterType((*MsgCancelToken)(nil), "fury.token.v1beta1.MsgCancelToken")
	proto.RegisterType((*MsgCancelTokenResponse)(nil), "fury.token.v1beta1.MsgCancelTokenResponse")
	proto.RegisterType((*MsgPauseToken)(nil), "fury.token.v1beta1.MsgPauseToken")
	proto.RegisterType((*MsgPauseTokenResponse)(nil), "fury.token.v1beta1.MsgPauseTokenResponse")
	proto.RegisterType((*MsgStopToken)(nil), "fury.token.v1beta1.MsgStopToken")
	proto.RegisterType((*MsgStopTokenResponse)(nil), "fury.token.v1beta1.MsgStopTokenResponse")
}

func init() { proto.RegisterFile("fury/token/v1beta1/tx.proto", fileDescriptor_bb958a4ae6c01cf1) }
...
func (c *msgClient) CreateToken(ctx context.Context, in *MsgCreateToken, opts ...grpc.CallOption) (*MsgCreateTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/CreateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) MintToken(ctx context.Context, in *MsgMintToken, opts ...grpc.CallOption) (*MsgMintTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/MintToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TransferToken(ctx context.Context, in *MsgTransferToken, opts ...grpc.CallOption) (*MsgTransferTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/TransferToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RetireToken(ctx context.Context, in *MsgRetireToken, opts ...grpc.CallOption) (*MsgRetireTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/RetireToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelToken(ctx context.Context, in *MsgCancelToken, opts ...grpc.CallOption) (*MsgCancelTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/CancelToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) PauseToken(ctx context.Context, in *MsgPauseToken, opts ...grpc.CallOption) (*MsgPauseTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/PauseToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) StopToken(ctx context.Context, in *MsgStopToken, opts ...grpc.CallOption) (*MsgStopTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.token.v1beta1.Msg/StopToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/CreateToken",
	}
...
func _Msg_MintToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/MintToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_TransferToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/TransferToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RetireToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/RetireToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/CancelToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_PauseToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/PauseToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_StopToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.token.v1beta1.Msg/StopToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.token.v1beta1.Msg",
	...
	Metadata: "fury/token/v1beta1/tx.proto",
}
...
func (m *MsgCreateToken) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Class = github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
