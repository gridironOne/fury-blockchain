...
// source: fury/token/v1beta1/authz.proto
...
func init() {
	proto.RegisterType((*MintAuthorization)(nil), "fury.token.v1beta1.MintAuthorization")
	proto.RegisterType((*MintConstraints)(nil), "fury.token.v1beta1.MintConstraints")
}

func init() { proto.RegisterFile("fury/token/v1beta1/authz.proto", fileDescriptor_cca6ff8f08fc36db) }
