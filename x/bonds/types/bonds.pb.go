...
// source: fury/bonds/v1beta1/bonds.proto
...
type Bond struct {
	...
	CreatorDid                   github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=creator_did,json=creatorDid,proto3,casttype=github.com/furyfoundation/fury-blockchain/x/iid/types.DIDFragment" json:"creator_did,omitempty" yaml:"creator_did"`
	ControllerDid                github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,5,opt,name=controller_did,json=controllerDid,proto3,casttype=github.com/furyfoundation/fury-blockchain/x/iid/types.DIDFragment" json:"controller_did,omitempty" yaml:"controller_did"`
	...
	OracleDid                    github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,28,opt,name=oracle_did,json=oracleDid,proto3,casttype=github.com/furyfoundation/fury-blockchain/x/iid/types.DIDFragment" json:"oracle_did,omitempty" yaml:"oracle_did"`
}
...
func (m *Bond) GetCreatorDid() github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.CreatorDid
	}
	return ""
...
func (m *Bond) GetControllerDid() github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
...
func (m *Bond) GetOracleDid() github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.OracleDid
	}
	return ""
...
type BaseOrder struct {
	AccountDid   github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=account_did,json=accountDid,proto3,casttype=github.com/furyfoundation/fury-blockchain/x/iid/types.DIDFragment" json:"account_did,omitempty" yaml:"account_did"`
...
func (m *BaseOrder) GetAccountDid() github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.AccountDid
	}
	return ""
...
func init() {
	proto.RegisterType((*FunctionParam)(nil), "fury.bonds.v1beta1.FunctionParam")
	proto.RegisterType((*BondDetails)(nil), "fury.bonds.v1beta1.BondDetails")
	proto.RegisterType((*Bond)(nil), "fury.bonds.v1beta1.Bond")
	proto.RegisterType((*BaseOrder)(nil), "fury.bonds.v1beta1.BaseOrder")
	proto.RegisterType((*BuyOrder)(nil), "fury.bonds.v1beta1.BuyOrder")
	proto.RegisterType((*SellOrder)(nil), "fury.bonds.v1beta1.SellOrder")
	proto.RegisterType((*SwapOrder)(nil), "fury.bonds.v1beta1.SwapOrder")
	proto.RegisterType((*Batch)(nil), "fury.bonds.v1beta1.Batch")
	proto.RegisterType((*Params)(nil), "fury.bonds.v1beta1.Params")
}

func init() { proto.RegisterFile("fury/bonds/v1beta1/bonds.proto", fileDescriptor_93b4137e78081347) }
...
func (m *BaseOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AccountDid = github_com_furyfoundation_fury_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
