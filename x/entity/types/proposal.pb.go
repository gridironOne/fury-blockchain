...
// source: fury/entity/v1beta1/proposal.proto
...
func init() {
	proto.RegisterType((*InitializeNftContract)(nil), "fury.entity.v1beta1.InitializeNftContract")
}

func init() { proto.RegisterFile("fury/entity/v1beta1/proposal.proto", fileDescriptor_460dff4269aaf83b) }
