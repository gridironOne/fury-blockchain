...
BOND_DID="did:fury:A7GK8p8rVhJMKhBVRCJJ8c"
#BOND_DID_FULL='{
...
MIGUEL_DID="did:fury:4XJLBfGtWSGKSz4BeRxdun"
MIGUEL_DID_FULL='{
...
fury_tx bonds buy 10abc 1000000res "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
fury_q bank balances "$MIGUEL_ADDR"

echo "Francesco buys 10abc..."
fury_tx bonds buy 10abc 1000000res "$BOND_DID" "$FRANCESCO_DID_FULL"
echo "Francesco's account..."
fury_q bank balances "$FRANCESCO_ADDR"

echo "Miguel sells 10abc..."
fury_tx bonds sell 10abc "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
fury_q bank balances "$MIGUEL_ADDR"
