...
fury_tx bonds buy 10001abc 100000res "$BOND_DID" "$SHAUN_DID_FULL" 
echo "Shaun cannot sell anything..."
fury_tx bonds sell 10000abc "$BOND_DID" "$SHAUN_DID_FULL" 
echo "Shaun can buy 10000abc..."
fury_tx bonds buy 10000abc 100000res "$BOND_DID" "$SHAUN_DID_FULL" 
...
fury_tx bonds sell 20000abc "$BOND_DID" "$MIGUEL_DID_FULL" 
echo "Miguel's account..."
fury_q bank balances "$MIGUEL_ADDR"
